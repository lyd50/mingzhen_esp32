...
extern int chaolv, jingshui, zongjin, gaoyabeng , youxian , jiare;//输出
...
extern  unsigned long ximo_begin ;
/*--------------------------------报警-------------------------------------------*/
//String state = ""; //??????
extern  unsigned long alarm_jiange;
extern  bool jingshui_chaoya , feishuiguoshao , alarm1 ;


extern unsigned long begintime , endtime, begintime2 , endtime2;
extern  unsigned long begintime_baohu , endtime_baohu;
/*-------------------------------启动原因------------------------------------------*/
